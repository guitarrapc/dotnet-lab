...
namespace JsonStreamLoggerSample.Logging.Infrastructure
{
    public class CustomJsonEntryWriter : IEntryWriter
    {
        ...
        public CustomJsonEntryWriter(Stream stream)
        {
            _stream = stream;
            _writer = new Utf8JsonWriter(stream, new JsonWriterOptions
            {
                ...
                // Non Escape list: onluy ascii
                //Encoder = JavaScriptEncoder.Default,

                // Escape list: "&'`+<> + Surrogate
                //Encoder = JavaScriptEncoder.Create(UnicodeRanges.All),

                // Escapelist: "&'`+<> + Surrogate
                //Encoder = JavaScriptEncoder.Create(UnicodeRanges.Hiragana, UnicodeRanges.Katakana, UnicodeRanges.CjkUnifiedIdeographs, UnicodeRanges.BasicLatin),
